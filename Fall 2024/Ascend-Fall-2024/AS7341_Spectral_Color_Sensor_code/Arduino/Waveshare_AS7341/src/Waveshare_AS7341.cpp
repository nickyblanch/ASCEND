...
{
	DEV_I2C_Init(AS7341_ADDRESS);//8-bit afddress
...
void AS7341_Enable(bool flag)
{
    ...
    if(data1 == data)
        Serial.print("Initialization is complete !\r\n");
    else
    {
        Serial.print("initialization is failure !\r\n");
        Serial.print("Please check whether the IIC pin is connected correctly and whether the IIC function is normal \r\n");
        Serial.print("Please press the reset button or run the program again after checking \r\n");
        while(1);
    }
